...
const seriesData: SeriesCard[] = [
  {
    ...
    description: "2x Brighter than stock. Street-legal SAE patterns. Perfect plug-and-play upgrade for city and highway commutes.",
    startingPrice: 16499,
  ...
  },
  {
    ...
    description: "4x Brighter. Maximum intensity for dark highways and trails. The #1 choice for Thar and Scorpio-N owners.",
    startingPrice: 25299,
